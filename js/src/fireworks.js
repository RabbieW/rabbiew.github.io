...
{
	var a = {};
	return a.x = e, a.y = t, a.color = colors[anime.random(0, colors.length - 1)], a.radius = anime.random(5, 10), a.endPos = setParticuleDirection(a), a.draw = function()
	{
...
if (canvasEl)
{
	var ctx = canvasEl.getContext("2d"),
		...
		pointerY = 0,
		tap = "mousedown",
		colors = ["#BB8BED", "#7AE8F7", "#E85A66"/*, "#FBF38C"*/],
